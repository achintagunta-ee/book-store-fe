		...
		<>
			<header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-primary/20 px-4 py-3 sm:px-6 lg:px-10">
				...
				<div className="hidden md:flex items-center justify-end gap-4">
					<div className="hidden !h-10 min-w-40 max-w-64 flex-col sm:flex">
						<div className="flex h-full w-full flex-1 items-stretch rounded-lg">
							<div className="flex items-center justify-center rounded-l-lg border-r-0 border-none bg-primary/20 pl-4 text-text-light/70 /70">
								<Search className="h-5 w-5" />
							</div>
							<input
								className="form-input h-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-lg border-none bg-primary/20 px-4 pl-2 font-body text-base font-normal leading-normal text-text-light placeholder:text-text-light/70 focus:outline-none focus:ring-0  dark:placeholder:text-text-main-dark/70"
								placeholder="Search"
							/>
						</div>
					</div>
			...
			{isMenuOpen && (
				<div className="fixed inset-0 z-50 flex flex-col bg-white  text-text-light ">
					...
					<div className="flex flex-1 flex-col gap-6 p-4 sm:p-6">
						{/* Mobile Search */}
						<div className="!h-10 w-full flex-col flex">
							<div className="flex h-full w-full flex-1 items-stretch rounded-lg">
								<div className="flex items-center justify-center rounded-l-lg border-r-0 border-none bg-primary/20 pl-4 text-text-light/70 /70">
									<Search className="h-5 w-5" />
								</div>
